...
while(True):
    ...
    # show video stream
    cv2.putText(gray, "A - Attentive", (10, 15),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(255,255,255), 2)
    cv2.putText(gray, "C - Careless", (10, 35),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(255,255,255), 2)
    cv2.putText(gray, "S - Cheater", (10, 55),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(255,255,255), 2)
    ...
    if  key == ord('q'):
        ...
        capture_face_expression(face_expression,"attentive",dataset_path)
        print("[INFO] Attentive")
    elif key == ord('c'):
        capture_face_expression(face_expression,"careless",dataset_path)
        print("[INFO] Careless")
    elif key == ord('s'):
        capture_face_expression(face_expression,"cheater",dataset_path)
        print("[INFO] Cheater")
